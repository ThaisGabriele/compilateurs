...
public class Scanner {
	...
	static {
		...
		literals.put("para", new Integer(9));
		literals.put("repita", new Integer(10));
		literals.put("leia", new Integer(11));
		literals.put("escreva", new Integer(12));
		literals.put("retorne", new Integer(13));
		literals.put("constante", new Integer(14));
		literals.put("novo", new Integer(15));
		literals.put("algoritmo", new Integer(16));
		...
		literals.put("procedimento", new Integer(21));
		literals.put("inteiro", new Integer(25));
		literals.put("tamanho", new Integer(45));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 31:
					...
					else if (ch == 'm') {AddCh(); state = 32; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 32:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'r' || ch >= 't' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 's') {AddCh(); state = 33; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 33:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'e') {AddCh(); state = 34; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 34:
					recEnd = pos; recKind = 1;
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
